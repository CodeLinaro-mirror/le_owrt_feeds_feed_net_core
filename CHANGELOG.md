...
- [odl-generator](https://gitlab.com/prpl-foundation/components/utilities/odl-generator): Disable Endpoint feature
...
- [tr181-dns](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-dns): Hosts, HostName and DomainName configuration

### Removed

- [libqosmod](https://gitlab.com/prpl-foundation/components/core/libraries/libqosmod): Component removed
- [tr181-bridging](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-bridging): Remove the loading of the UCI config
...
- [deviceinfo-manager](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-deviceinfo): [TR181-DeviceInfo] HardwareVersion, SoftwareVersion
...
- [dhcpv4-manager](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-dhcpv4): update DNS data model with hosts from DHCP server pool
...
- [dhcpv6s-manager](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-dhcpv6s): update DNS data model with hosts from DHCP server pool
...
- [ethernet-manager](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-ethernet): Issue:   HOP-598  [NetDev][ethernet manager] Extend netdev with support of ethtool status parameters
...
- [ethernet-manager](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-ethernet): [import-dbg] Disable import-dbg by default for all amxrt plugin
...
- [libdhcpoptions](https://gitlab.com/prpl-foundation/components/core/libraries/libdhcpoptions): update DNS data model with hosts from DHCP server pool
...
- [libqosmodule](https://gitlab.com/prpl-foundation/components/core/libraries/libqosmodule): Component added
- [libqosnode](https://gitlab.com/prpl-foundation/components/core/libraries/libqosnode): Component added
- [moca-manager](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-moca): Add AssociatedDevice Table support
- [mod-autosensing](https://gitlab.com/prpl-foundation/components/core/modules/mod-autosensing): Component added
...
- [mod-fw-host](https://gitlab.com/prpl-foundation/components/core/modules/mod-fw-host): Component added
...
- [mod-qos-tc](https://gitlab.com/prpl-foundation/components/core/modules/mod-qos-tc): - [libqosmodule] Integrate library
...
- [routing-manager](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-routing): [amx][routing]Create a null route for IPv6 prefix delegation
...
- [tr181-dhcpv4client](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-dhcpv4client): [import-dbg] Disable import-dbg by default for all amxrt plugin
...
- [tr181-dhcpv6client](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-dhcpv6client): [dhcpv6client] Implement RequestAddresses and RequestPrefixes parameters
- [tr181-dns](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-dns): Dynamic handling of network events (PPP)
- [tr181-dns](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-dns): move part of DNSMode functionality to tr181-dns
...
- [tr181-firewall](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-firewall): [prpl][amx] [Firewall] Implementation of WANAccess blocking
- [tr181-firewall](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-firewall): [Firewall] [NAT] Indicate which interfaces are NAT capable in NetModel
...
- [tr181-ppp](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-ppp): [ppp][ipv6] It must be possible to support pppv6 (ip6cp) with the ppp plugin
...
- [tr181-routeradvertisement](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-routeradvertisement): [import-dbg] Disable import-dbg by default for all amxrt plugin
...
- [tr181-routeradvertisement](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-routeradvertisement): [prpl][tr181-routeradvertisment] implement radvd module
- [tr181-routeradvertisement](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-routeradvertisement): [tr181][Routeradvertisement] move netmodel query to modules
- [tr181-routeradvertisement](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-routeradvertisement): [tr181][routeradvertisment] does not update prefixes
- [tr181-upnp](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-upnp): Component added
- [tr181-usermanagement](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-usermanagement): [tr181 Usermanagement] Add %out parameter to the CheckCredentialsDiagnostics function
- [tr181-xpon](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-xpon): Component added
- [wan-autosensing](https://gitlab.com/prpl-foundation/components/core/plugins/wan-autosensing): [import-dbg] Disable import-dbg by default for all amxrt plugin
...
- [wan-manager](https://gitlab.com/prpl-foundation/components/core/plugins/wan-manager): [ipv6][dslite][wanmanager] Add support for dslite in the WANManager
...
- [wan-manager](https://gitlab.com/prpl-foundation/components/core/plugins/wan-manager): Implement autosensing directly in the DM/plugin
- [wan-manager](https://gitlab.com/prpl-foundation/components/core/plugins/wan-manager): [ppp][ipv6] It must be possible to support pppv6 (ip6cp) with the ppp plugin
- [wan-manager](https://gitlab.com/prpl-foundation/components/core/plugins/wan-manager): Add the possibility to configure the DNS (Mode + Servers)
- [wan-manager](https://gitlab.com/prpl-foundation/components/core/plugins/wan-manager): Set/clear Logical.Interface.X in WANManager
- [wan-manager](https://gitlab.com/prpl-foundation/components/core/plugins/wan-manager): Enable PCP when WANMode == DSLite
- [wan-manager](https://gitlab.com/prpl-foundation/components/core/plugins/wan-manager): implement the getWANMode function
- [wan-manager](https://gitlab.com/prpl-foundation/components/core/plugins/wan-manager): Prepare debian package + changelog
...
- [dhcpv4-manager](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-dhcpv4): [dhcpv4-manager] prevent error in bit endianness
- [dhcpv4-manager](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-dhcpv4): [dhcpv4-manager] lease is not added to DM if given between start and subscribe
- [dhcpv4-manager](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-dhcpv4): avoidable copies of strings, htables and lists
...
- [dhcpv6s-manager](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-dhcpv6s): [dhcpv6s-manager] enable guest pool
- [dhcpv6s-manager](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-dhcpv6s): [dhcpv6-manager] send event when status is updated
- [dhcpv6s-manager](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-dhcpv6s): avoidable copies of strings, htables and lists
- [dhcpv6s-manager](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-dhcpv6s): No GUA Address received after IA_NA request is sent
...
- [ip-manager](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-ip): GUA_RA IPv6Address is not filled in for ppp6
- [ip-manager](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-ip): No IPv4 queries created if LowerLayers is empty during enable
- [ip-manager](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-ip): Improve stability
...
- [libfwrules](https://gitlab.com/prpl-foundation/components/core/libraries/libfwrules): avoidable copies of strings, htables and lists
...
- [mod-vlan-uci](https://gitlab.com/prpl-foundation/components/core/modules/mod-vlan-uci): avoidable copies of strings, htables and lists
...
- [multisettings](https://gitlab.com/prpl-foundation/components/core/plugins/multisettings): Cannot Disable multisettings service
...
- [netdev-plugin](https://gitlab.com/prpl-foundation/components/core/plugins/netdev): Move netlink code from IP-manager to NetDev
- [netdev-plugin](https://gitlab.com/prpl-foundation/components/core/plugins/netdev): Fix copyright in the debian packages
- [netdev-plugin](https://gitlab.com/prpl-foundation/components/core/plugins/netdev): No event sent for State changes on bridge interfaces
...
- [pcm-manager](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-pcm): [tr181-pcm] unit test teardown has error
- [pcm-manager](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-pcm): avoidable copies of strings, htables and lists
...
- [routing-manager](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-routing): Fails to set default route when switching from ppp mode
- [routing-manager](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-routing): Fails to set default route when switching from ppp mode
...
- [tr181-bridging](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-bridging): Vlans are not added correctly to the bridge
- [tr181-bridging](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-bridging): init without clean on local variables
- [tr181-bridging](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-bridging): avoidable copies of strings, htables and lists
- [tr181-bridging](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-bridging): Remove comma preventing bridging manager to start
...
- [tr181-dhcpv4client](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-dhcpv4client): avoidable copies of strings, htables and lists
- [tr181-dhcpv4client](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-dhcpv4client): [DHCPv4 Renew] typo in Renew() command
- [tr181-dhcpv4client](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-dhcpv4client): When DHCP Client Option 60 is set using data model, the default DHCP option 60 is not modified and 2 DHCP option60 are sent
- [tr181-dhcpv4client](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-dhcpv4client): debug logs in syslog with trace level 200
- [tr181-dhcpv4client](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-dhcpv4client): [CDROUTER][DHCP] Box is no more sending Hostname DHCP Option 12 in WAN DHCP packets
...
- [tr181-dhcpv6client](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-dhcpv6client): [Config] coredump generation should be configurable
- [tr181-dhcpv6client](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-dhcpv6client): avoidable copies of strings, htables and lists
...
- [tr181-dns](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-dns): no DNS: router advertisement option RDNSS parsing is wrong
- [tr181-dns](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-dns): tr181-dns process doesn't stop with SIGTERM (stuck in ps state Rs)
...
- [tr181-firewall](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-firewall): [ipv6][cdrouter] Some tests are failing
- [tr181-firewall](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-firewall): [prpl][amx] [Firewall] Implementation of WANAccess blocking
...
- [tr181-neighbordiscovery](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-neighbordiscovery): avoidable allocation with amxc_string_dup
- [tr181-neighbordiscovery](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-neighbordiscovery): [tr181-ppp] Sometimes there is no default route for ppp6
...
- [tr181-ppp](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-ppp): avoidable copies of strings, htables and lists
- [tr181-ppp](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-ppp): [TR181 PPP] PPP blocking during PPPoE Discovery
- [tr181-ppp](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-ppp): [wan-manager] PPP connects twice when behind a VLAN.
...
- [tr181-qos](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-qos): - [VLAN][QOS][WNC] Changing the WANMode to vlan, QoS queues creating will fail
- [tr181-qos](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-qos): avoidable copies of strings, htables and lists
...
- [tr181-routeradvertisement](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-routeradvertisement): [TR181][Routeradvertisment] wait for IP
...
- [tr181-usermanagement](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-usermanagement): Do not remove files before overwriting them
- [tr181-usermanagement](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-usermanagement): [UserManagement] Excessive writes to passwd,group,shadow on start
- [tr181-usermanagement](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-usermanagement): [UserManagement] Excessive writes to passwd,group,shadow on start
...
- [wan-manager](https://gitlab.com/prpl-foundation/components/core/plugins/wan-manager): [Wan Manager] PPP credentials not used
- [wan-manager](https://gitlab.com/prpl-foundation/components/core/plugins/wan-manager): RoutingManager does not get its interface reference updated when switching modes in wan-manager
- [wan-manager](https://gitlab.com/prpl-foundation/components/core/plugins/wan-manager): avoidable copies of strings, htables and lists
- [wan-manager](https://gitlab.com/prpl-foundation/components/core/plugins/wan-manager): Adapt the Wan-Manager to use DNS management functions of the TR181-DNS plugin
- [wan-manager](https://gitlab.com/prpl-foundation/components/core/plugins/wan-manager): [tr181-ppp] Sometimes there is no default route for ppp6
- [wan-manager](https://gitlab.com/prpl-foundation/components/core/plugins/wan-manager): Improve stability
...
- [mod-fw-amx](https://gitlab.com/prpl-foundation/components/core/modules/mod-fw-amx): random: dropbear is not running
- [mod-qos-tc](https://gitlab.com/prpl-foundation/components/core/modules/mod-qos-tc): [tr181-qos] random: QoS.Queue reported as misconfigured
...
- [tr181-bridging](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-bridging): Adapt odl defaults to match for wnc
- [tr181-dhcpv6client](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-dhcpv6client): update DNS data model with hosts from DHCP server pool
...
- [tr181-dns](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-dns): add more debug info
...
- [tr181-ppp](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-ppp): Use mod-ppp-uci controller as default
- [tr181-qos](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-qos): [tr181-qos] random: QoS.Queue reported as misconfigured
...
- [deviceinfo-manager](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-deviceinfo): Implement swupdate on wnc board
- [dhcpv4-manager](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-dhcpv4): [CI] Add missing dependency on libdhcpoptions
...
- [dhcpv6s-manager](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-dhcpv6s): [CI] Update dependencies
...
- [ip-manager](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-ip): Configure static IPv4 and IPv6 addresses trough the wan-manager
- [libfwinterface](https://gitlab.com/prpl-foundation/components/core/libraries/libfwinterface): Add missing iptables conmark extension dependency
...
- [moca-manager](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-moca): - MoCA interfaces must be synchronized with Netmodel
...
- [mod-pcm-svc](https://gitlab.com/prpl-foundation/components/core/modules/mod-pcm-svc): [mod-pcm-svc] generated datamodel documentation is empty
...
- [multisettings](https://gitlab.com/prpl-foundation/components/core/plugins/multisettings): Add verbosity/debug logs to Multisetting component
...
- [tr181-device](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-device): Implement autosensing directly in the DM/plugin
...
- [tr181-firewall](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-firewall): - [UPNP] UPNP plugin must open the relevant ports for UPNP discovery for both ipv4 and IPv6
...
- [tr181-neighbordiscovery](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-neighbordiscovery): Add missing STAGING_LIBDIR to LDFLAGS
...
- [tr181-ppp](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-ppp): Add missing STAGING_LIBDIR to LDFLAGS
- [tr181-ppp](https://gitlab.com/prpl-foundation/components/core/plugins/tr181-ppp): tr181-ppp: documentation generation fails
...
- [wan-manager](https://gitlab.com/prpl-foundation/components/core/plugins/wan-manager): Configure static IPv4 and IPv6 addresses trough the wan-manager

## Release proj_prpl_M4.1-2022_v1.2.2 - 2023-02-15(13:47:54 +0000)

## Release proj_prpl_M4.1-2022_v1.2.1 - 2023-02-02(12:00:55 +0000)
...
## Release proj_prpl_M4.1-2022_v1.0.1 - 2022-12-23(14:33:11 +0000)
